...
def save(x, y, name):
    file = open(name, "wb")
    np.savez_compressed(file, inputs=x, targets=y)

def compress(dataset_name):
    path_to_test = "./{:s}_2048_test.txt".format(dataset_name)
    path_to_train = "./{:s}_2048_train.txt".format(dataset_name)
    ...
    path_to_npz_test = "./{:s}_2048_test.npz".format(dataset_name)
    path_to_npz_train = "./{:s}_2048_train.npz".format(dataset_name)
